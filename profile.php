       ...
       <div class="jumbotron text-center" style="background-color: #567189;">
        ...
        <?php if( $user_p['id'] === $user['id']):?>
         <ul class="nav nav-pills nav-stacked">
          <li><a href="edit_account.php" data-toggle="tooltip" data-placement="bottom" title="Edit account"> <i class="far fa-edit" style="color: #567189;"></i> <strong style="color: #567189;">Edit Account</a></li></strong>
         </ul>
       <?php endif;?>
       </div>
   </div>
