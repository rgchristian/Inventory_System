...
<?php
$sales = find_all_sale();
$total_price = 0; // Variable to store the total quantity

// Calculate the total quantity
foreach ($sales as $sale) {
  $total_price += (int)$sale['price'];
}
?>
    ...
    <div class="col-md-12">
      <div class="panel panel-info">
        <div class="panel-heading clearfix">
          ...
          <a href="#" class="btn custom-primary-btn btn-sm" data-toggle="tooltip" data-placement="bottom" title="Total sales"><i class="fas fa-dollar-sign">&nbsp;</i><span><?php echo "<span data-toggle='tooltip' data-placement='bottom'>" . $total_price . "</span>"; ?></span></a>
